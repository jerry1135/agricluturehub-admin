...
$msg2="";
 ...
 if ($_SERVER["REQUEST_METHOD"]=="POST")
 {
	...
	if($_POST["category_name"]=="")
	  ...
	  {
	     $msg1="Please Enter Category Description";
	  }
	  if($_POST["category_pic"]=="")
	  {
	     $msg2="Please Enter Category Picture";
	  }
        ...
        $cpic=$_POST["category_pic"];
         ...
         if($cname!='' && $cdesc!='' && $cpic!='')
        {
            $sql = "insert into category (category_name,category_desc,category_pic)values('".$cname."','".$cdesc."','".$cpic."')";
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Insert Category</h4><br/>
                                    <form class="form" method="POST" action="">
                                    <div class="form-group mt-5 row">
                                        <label for="example-text-input" class="col-2 col-form-label">Category Name</label>
                                        <div class="col-10">
                                        <input class="form-control" type="text" id="example-text-input" name="category_name">
									...
									<div class="form-group mt-5 row">
                                        ...
                                        <div class="col-10">
                                        <input class="form-control" type="text" id="example-text-input" name="category_desc">
									...
									<div class="form-group mt-5 row">
                                        ...
                                        <div class="col-10">
                                        <input class="form-control" type="file" id="example-text-input" name="category_pic" accept="image/*" onchange="loadFile(event)">

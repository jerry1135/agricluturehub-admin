...
$edate= "";
  ...
  if($_SERVER["REQUEST_METHOD"]=="POST")
  {
      if(isset($_POST["sdate"]) && isset($_POST["edate"]))
	  {
	       $sdate = $_POST["sdate"];
		   $edate = $_POST["edate"];
		   $sql = "select * from `order` o JOIN `user` u where o.user_id = u.user_id and order_date >= '".$sdate."' and order_date <= '".$edate."'";
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">All Order List Table</h4>
                                
								<?php
						         if($sdate!="" && $edate!="")
						          {
						        ?>
						        <a href="Reports/order_report.php?sdate=<?php echo $sdate?>&edate=<?php echo $edate?>">Generate Report</a>
						        <?php
						          }
						        else
						          {
                                ?>
							    <a href="Reports/order_report.php">Generate Report</a>
							    <?php
							      }
							    ?>

            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Update City</h4><br/>
                                    <form class="form" method="POST" action="">
                                    <div class="form-group mt-5 row">
                                        <label for="example-text-input" class="col-2 col-form-label">City Name</label>
                                        <div class="col-10">
                                        <input class="form-control" type="text" id="example-text-input" name="city_name" value="<?php echo $row['city_name']?>">
                                        </div>
                                    </div>
...
if ($_SERVER["REQUEST_METHOD"]=="POST")
 {
    if(isset($_POST["city_name"]))
    {
        ...
        if($cname!='')
        {
            $sql = "update city set city_name='".$cname."' where city_id=$id";
            $result = mysqli_query($conn,$sql);
            echo "result = " . $result;
            if($result)
            {

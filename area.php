                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle"><a href="insert-area.php">INSERT</a></h6>
                                <div class="table-responsive m-t-40">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
<?php 
$sql = "select * from `area` a JOIN `city` c where a.city_id = c.city_id";
$result = mysqli_query($conn,$sql);
while($row = mysqli_fetch_array($result))
{
    $id = $row ['area_id'];
	$name = $row ['area_name'];
	$pincode = $row ['area_pincode'];
	$cname = $row ['city_name'];
 ...
 ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href ="delete-area.php?id=<?php echo $id?>"><img src="delete.png" height="30"></a>
                                                <a href ="update-area.php?id=<?php echo $id?>&name=<?php echo $name?>&pincode=<?php echo $pincode?>&cname=<?php echo $cname?>"><img src="edit.png" height="30"></a>
                                                </td>

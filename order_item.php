            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">View Item</h4>
                    </div>
...
<?php
$id=$_GET["oid"]; 
$sql = "select * from `orderitem` i JOIN `order` o JOIN product p join productimage e where i.order_id = o.order_id and i.product_id=p.product_id and e.p_image_id=p.product_id and o.order_id='".$id."'";

                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle"><a href="insert-city.php">INSERT</a></h6>
...
while($row = Mysqli_fetch_array($result))
{
 ...
 ?>
                                             <tr>
                                                ...
                                                <td><a href ="delete-city.php?id=<?php echo $id?>"><img src="delete.png" height="30"></a>
                                                <a href ="update-city.php?id=<?php echo $id?>&name=<?php echo $name?>"><img src="edit.png" height="30"></a>
                                                </td>

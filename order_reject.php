...
$mail="select * from `order` o join user u where o.user_id=u.user_id and order_id='".$id."'";
...
if($result)
{
             ...
             //  $die;
                    ...
                    if($result)
                    {
                         ...
                         $message = "<h3>Your order  &#8377; '".$product."' is Rejected. Place Order Again.  Thank You :) </h3>";

                            ...
                            <div class="card-body">
                                <h4 class="card-title">UPDATE CATEGORY</h4><br/>
                                    ...
                                    <div class="form-group mt-5 row">
                                        ...
                                        <div class="col-10">
                                           <input class="form-control" type="text" id="example-text-input" name="category_name" value="<?php echo $row['category_name']?>">
                                        </div>
                                    </div>
									<div class="form-group mt-5 row">
                                        <label for="example-text-input" class="col-2 col-form-label">Category Desc</label>
                                         <div class="col-10">
                                            <textarea rows="5" class="form-control" type="search" id="example-search-input" name="category_desc" ><?php echo $row['category_desc'];?></textarea>
                                        </div>
                                        
                                    </div>
									<div class="form-group mt-5 row">
                                        <label for="example-text-input" class="col-2 col-form-label">Category Pic</label>
                                         <div class="col-10">
                                           <input class="form-control" type="file" id="example-text-input" name="category_pic"  accept="image/*" onchange="loadFile(event)"  value="<?php echo $row['category_pic']?>">
...
if ($_SERVER["REQUEST_METHOD"]=="POST")
 {
    if(isset($_POST["category_name"]) && isset($_POST["category_desc"]) && isset($_POST["category_pic"]))
    {
        $cname=$_POST["category_name"];
		$cdesc=$_POST["category_desc"];
        $cpic=$_POST["category_pic"];
        
         if($cname!='' && $cdesc!='' && $cpic!='')
        {
            $sql = "update category set category_name='".$cname."', category_desc='".$cdesc."', category_pic='".$cpic."' where category_id=$id";
            $result = mysqli_query($conn,$sql);
            echo "result = " . $result;
            if($result)
            {

            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">ProductImage Table</h4>
                                <h6 class="card-subtitle"><a href="insert-productimage.php">INSERT</a></h6>
                                <div class="table-responsive m-t-40">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
<?php 
$sql = "select * from `productimage` i JOIN product p where i.product_id=p.product_id";
...
while($row = Mysqli_fetch_array($result))
{
 ...
 ?>
                                             <tr>
                                                <td><img src="../../../image/product/<?php echo $row["image_path"];?>" alt="user-img" class="img-circle" height="80px" width="80px"></td>
												<td><?php echo $row['product_name']?></td>
                                                <td><a href ="delete-productimage.php?id=<?php echo $id?>"><img src="delete.png" height="30"></a>
                                                <a href ="update-productimage.php?id=<?php echo $id?>&ip=<?php echo $ip?>&pname=<?php echo $pname?>"><img src="edit.png" height="30"></a>
                                                </td>
                                                </td>

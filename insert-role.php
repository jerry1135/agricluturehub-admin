	...
	if($_POST["role_name"]=="")
	  {
        ...
        $rname=$_POST["role_name"];
         if($rname!='')
        {
            $sql = "insert into role (role_name)values('".$rname."')";
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Insert Table</li>
                            </ol>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">INSERT Role</h4><br/>
                                    <form class="form" method="POST" action="">
                                    <div class="form-group mt-5 row">
                                        <label for="example-text-input" class="col-2 col-form-label">Role Name</label>
                                        <div class="col-10">
                                        <input class="form-control" type="text" id="example-text-input" name="role_name">

            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Service Booking Table</h4>
...
while($row = Mysqli_fetch_array($result))
{
 ...
 ?>
                                             <tr>
												...
												<td><?php if($row['booking_status']==0)
												   {
												      echo "pending";
												   }
												...
												<td><a style="color: #18F70D;cursor: pointer" href="servicebooking_accept.php?id=<?php echo $id;?>">ACCEPT</a> &nbsp
                                                <a style="color: red ;cursor: pointer" href="servicebooking_reject.php?id=<?php echo $id;?>">REJECT</a> </td>    
                                                <td><a href="servicebooking_status.php?id=<?php echo $id;?>">View Status</td>
                                                </tr>
<?php
}
?>

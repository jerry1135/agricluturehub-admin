...
$edate = "";
 if($_SERVER["REQUEST_METHOD"]=="POST")
 {
    if(isset($_POST["sdate"]) && isset($_POST["edate"]))
    {
        $sdate = $_POST["sdate"];
        $edate = $_POST["edate"];
        $sql = "select * from `servicebooking` s JOIN `user` u JOIN `servicepackage` p where s.user_id = u.user_id and s.s_package_id=p.s_package_id and s_booking_date>='".$sdate."' and s_booking_date<='".$edate."'";
                            ...
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Data table example</h6>
                                  ...
                                  <?php
                                    ...
                                    {
                                        ?>
                                        <a href="s_b.php?sdate=<?php echo $sdate ?>
                                        &edate=<?php echo $edate ?>"> Generate Report </a>
                                    <?php  
                                }
                                else
                                {
                                  ?>
                                  <a href="s_b.php">Genrate report </a>
                                  <?php
                              }
                              ?>
                                <from method="POST">

            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Order Item Table</h4>
...
<?php
//$id=$_GET['id']; 
//$sql = "select * from `orderitem` i JOIN `order` o JOIN product p where i.order_id = o.order_id and i.product_id=p.product_id and o.order_id";

$sql = "select * from `orderitem` i JOIN `order` o JOIN product p JOIN `productimage` e where i.order_id = o.order_id and 
i.product_id=p.product_id and o.order_id";
...
while($row = Mysqli_fetch_array($result))
{
 ...
 ?>
                                             <tr>
												...
												<td><img src="../../../Images/productimages/<?php echo $row["image_path"];?>" alt="user-img" class="img-circle" height="80px" width="80px"></td>

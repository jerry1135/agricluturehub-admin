...
if(isset($_GET['id']))
{
    ...
    $sql = "select * from productimage where p_image_id = $id";
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Update Product Image</h4><br/>
                                <form class="form" method="POST" action="">
                                    <div class="form-group mt-5 row">
                                        <label for="example-text-input" class="col-2 col-form-label">Image Path</label>
                                        <div class="col-10">
                                            <input class="form-control" type="file" id="example-text-input" name="image_path" accept="image/*" onchange="loadFile(event)" value="<?php echo $row['image_path']?>" >
...
<?php
 ...
 {
    if(isset($_POST["image_path"]) && isset($_POST["product_id"]))
    {
        $ip=$_POST["image_path"];
        $pid=$_POST["product_id"];
        if($ip!='' && $pid!='')
        {
            $sql = "update productimage set image_path='".$ip."',product_id='".$pid."' where p_image_id=$id";

            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Service Booking Status</h4>
                                    ...
                                    <table id="myTable" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>sevice booking Appoinment date</th>
...
<?php
$id=$_GET["id"]; 
$sql = "select * from `servicebooking` s JOIN `user` u JOIN `servicepackage` p where s.user_id = u.user_id and s.s_package_id=p.s_package_id and s.s_booking_id='".$id."'";
$result = mysqli_query($conn,$sql);
while($row = Mysqli_fetch_array($result))
{
    $bid = $row ['s_booking_id'];

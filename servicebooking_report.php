...
$edate= "";
  ...
  if($_SERVER["REQUEST_METHOD"]=="POST")
  {
      if(isset($_POST["sdate"]) && isset($_POST["edate"]))
	  {
	       $sdate = $_POST["sdate"];
		   $edate = $_POST["edate"];
		   $sql = "select * from `servicebooking` s JOIN `user` u JOIN `servicepackage` p where s.user_id = u.user_id 
		   and s.s_package_id=p.s_package_id and s_booking_date >= '".$sdate."' and s_booking_date <= '".$edate."'";
...
{
  $sql = "select * from `servicebooking` s JOIN `user` u JOIN `servicepackage` p where s.user_id = u.user_id and s.s_package_id=p.s_package_id";
}
?>
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">All service Booking</li>
                            </ol>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">All Service Booking Table</h4>
                                
								<?php
						         if($sdate!="" && $edate!="")
						          {
						        ?>
						        <a href="Reports/servicebooking_report.php?sdate=<?php echo $sdate?>&edate=<?php echo $edate?>">Generate Report</a>
						        <?php
						          }
						        else
						          {
                                ?>
							    <a href="Reports/servicebooking_report.php">Generate Report</a>
							    <?php
							      }
							    ?>
...
while($row = Mysqli_fetch_array($result))
{
 ...
 ?>
                                             <tr>
                                                <td><?php echo $row['s_booking_date']?></td>
